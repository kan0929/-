...
large_buttons = {
    ...
    "나를 표현한 음악": "new music.mp3"  # 이 경로를 실제 음악 파일로 변경하세요.
}

small_buttons = {
    "나의 장점": "끈기있게 꾸준히 노력합니다.",
    "희망 진로": "프로그래머가 되고 싶습니다.",
    "좋아하는 것": "여행, 악기 연주, 코딩을 좋아합니다.",
    "싫어하는 것": "제가 싫어하는 것은 가지를 싫어합니다",
    "자기 소개": "저는 서산중앙고등학교에 재학 중인 고등학교 3학년 안수윤입니다.",
    "진로 준비": "현재 진로에 진학하기 위해 수학과 물리학 등 여러 과목을 다양하게 공부하고 있습니다.",
    "취미 활동": "현재 알토 색소폰을 연주하고 있으며 그에 따라 학교 내에 관악부에서 활동을 하고 있습니다.",
}
...
if st.session_state.active_button == "나를 표현한 음악":
    st.audio("new music.mp3", format="audio/mp3")
